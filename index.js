...
// This bot's main dialog.  ---> YOUR DECLRATIONS
const { DialogAndWelcomeBot } = require('./bots/dialogAndWelcomeBot');
const { MainDialog } = require('./dialogs/mainDialog');

// Create HTTP server --> SAME
...
const onTurnErrorHandler = async (context, error) => { // --> SAME
...
server.on('upgrade', (req, socket, head) => { //--> DELETE?
